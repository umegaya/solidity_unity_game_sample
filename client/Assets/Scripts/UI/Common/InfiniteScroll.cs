...
public class InfiniteScroll : UIBehaviour
{
	...
	public int listViewSize = 10;
	int instantateItemCount = 12;
	...
	public void AdjustContentSize(int n_list_size) 
	{
		RefreshList();
	}
	...
	public void RefreshList() {
		...
		foreach (var i in itemList) {
			onUpdateItem.Invoke(currentItemNo + index, i.gameObject);
			index++;
		}
	}
	...
	protected override void Start ()
	{
		...
		instantateItemCount = listViewSize + 2;
